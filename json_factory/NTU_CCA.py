...
folder_path = "./ipfs_metadata/cca/NTU_20232024/"
# Load environment variables from .env
load_dotenv()

# Define student names and universities
ntu_students = os.getenv("NTU_STUDENTS").split(",")

universities = {student: "Nanyang Technological University" for student in ntu_students}
...
for student in ntu_students:
    num_records = random.randint(0, 2)
    selected_records = random.sample(academic_years, num_records)
